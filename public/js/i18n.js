...
const I18N_EN = {
  ...
  memories: {
    ...
    weekOf: 'Week of {date}',
    legend: 'Grouped by project and tag · tap a memory to open it',
  ...
  projects: {
    ...
    emptyTitle: 'Give your memories a home',
    emptyBody:
      'A project is a named home for memories about one thing: a website, a trip, a client. Memories filed under a project stay together in search and on the graph, and your AI tools can file into one for you.',
    emptyStart: 'Name your first project below.',
    createTitle: 'New project',
    nameLabel: 'Project name',
    namePlaceholder: 'e.g. Website relaunch',
    descLabel: 'Description',
    descPlaceholder: 'What is this project about? (optional)',
    layerLabel: 'Where this project lives',
    slugEmpty: 'Give it a short name. The slug is how tags and AI tools refer to it.',
    slugInvalid: 'Use at least one letter or number in the name.',
    ...
    countApprox: '{n}+ memories',
    countNone: 'No memories yet',
    ...
    memoriesEmpty:
      'Nothing filed here yet. Choose this project when you remember something, or add an alias below to pull in tags you already use.',
    memoriesShowing: 'Showing the latest {n} memories.',
    aliasesTitle: 'Aliases',
    aliasesHelp:
      'An alias pulls a tag you already use into this project. Memories with that tag show up here, and nothing is rewritten.',
    aliasNone: 'No aliases yet',
    aliasPlaceholder: 'Add an existing tag',
    aliasAdd: 'Add',
    aliasRemove: 'Remove alias {tag}',
    aliasSuggestLabel: 'Tags you already use',
    aliasSuggestTitle: 'Add {tag} as an alias',
    aliasInvalid: 'An alias must be a plain tag, like "cycling". Reserved tags such as kind: or project: cannot be used.',
    aliasLimit: 'A project can have up to 16 aliases.',
    aliasFailed: 'Could not update aliases',
    ...
    digestTitle: 'Digest',
    digestHelp: "Condense this project's memories into one summary memory. The originals are kept.",
    digestAction: 'Create digest',
    capsuleSub: 'What connected AI tools load before they work on this project.',
    slotCurrentState: 'Current state',
    slotDecisions: 'Decisions',
    slotOpenQuestions: 'Open questions',
    slotSet: 'In the capsule',
    capsuleHowTo:
      'To fill a slot, save a canonical memory tagged capsule:project:{slug} and capsule-slot:current-state (or decisions, open-questions).',
    manageTitle: 'Archive or delete',
    archive: 'Archive project',
    restore: 'Restore project',
    archiveHelp:
      'An archived project leaves the pickers and the nightly digest. Nothing is deleted, and you can restore it any time.',
...
const I18N_IT = {
  ...
  memories: {
    ...
    legend: 'Raggruppati per progetto e tag · tocca un ricordo per aprirlo',
  ...
  projects: {
    ...
    emptyTitle: 'Dai una casa ai tuoi ricordi',
    emptyBody:
      'Un progetto è una casa con un nome per i ricordi su una sola cosa: un sito, un viaggio, un cliente. I ricordi salvati in un progetto restano insieme nella ricerca e nel grafo, e i tuoi strumenti AI possono salvarli per te.',
    emptyStart: 'Dai un nome al tuo primo progetto qui sotto.',
    createTitle: 'Nuovo progetto',
    nameLabel: 'Nome del progetto',
    namePlaceholder: 'es. Rilancio del sito',
    descLabel: 'Descrizione',
    descPlaceholder: 'Di cosa parla questo progetto? (facoltativo)',
    layerLabel: 'Dove vive questo progetto',
    slugEmpty: 'Scegli un nome breve. Lo slug è il modo in cui tag e strumenti AI si riferiscono al progetto.',
    slugInvalid: 'Usa almeno una lettera o un numero nel nome.',
    slugTaken: 'Esiste già un progetto con questo slug.',
    slugPreview: 'Slug (identificativo): {slug}',
    create: 'Crea progetto',
    creating: 'Creazione…',
    createdToast: 'Progetto "{name}" creato',
    createFailed: 'Impossibile creare il progetto',
    count: {
      one: '{n} ricordo',
      other: '{n} ricordi',
    },
    countApprox: '{n}+ ricordi',
    countNone: 'Ancora nessun ricordo',
    archivedToggle: 'Archiviati ({n})',
    loading: 'Caricamento dei progetti…',
    loadFailed: 'Impossibile caricare i progetti',
    retry: 'Riprova',
    back: 'Tutti i progetti',
    archivedChip: 'Archiviato',
    memoriesTitle: 'Ricordi',
    memoriesEmpty:
      'Qui non c\'è ancora nulla. Scegli questo progetto quando ricordi qualcosa, oppure aggiungi un alias qui sotto per includere i tag che usi già.',
    memoriesShowing: 'Mostro gli ultimi {n} ricordi.',
    aliasesTitle: 'Alias',
    aliasesHelp:
      'Un alias porta in questo progetto un tag che usi già. I ricordi con quel tag compaiono qui e non viene riscritto nulla.',
    aliasNone: 'Ancora nessun alias',
    aliasPlaceholder: 'Aggiungi un tag esistente',
    aliasAdd: 'Aggiungi',
    aliasRemove: 'Rimuovi l\'alias {tag}',
    aliasSuggestLabel: 'Tag che usi già',
    aliasSuggestTitle: 'Aggiungi {tag} come alias',
    aliasInvalid: 'Un alias deve essere un tag semplice, come "ciclismo". I tag riservati come kind: o project: non sono ammessi.',
    aliasLimit: 'Un progetto può avere fino a 16 alias.',
    aliasFailed: 'Impossibile aggiornare gli alias',
    ...
    digestTitle: 'Riepilogo',
    digestHelp: 'Condensa i ricordi di questo progetto in un unico ricordo di sintesi. Gli originali restano.',
    digestAction: 'Crea riepilogo',
    capsuleSub: 'Ciò che gli strumenti AI collegati caricano prima di lavorare a questo progetto.',
    slotCurrentState: 'Stato attuale',
    slotDecisions: 'Decisioni',
    slotOpenQuestions: 'Domande aperte',
    slotSet: 'Nella capsula',
    capsuleHowTo:
      'Per riempire uno spazio, salva un ricordo canonico con tag capsule:project:{slug} e capsule-slot:current-state (oppure decisions, open-questions).',
    manageTitle: 'Archivia o elimina',
    archive: 'Archivia progetto',
    restore: 'Ripristina progetto',
    archiveHelp:
      'Un progetto archiviato esce dai selettori e dal riepilogo notturno. Non viene eliminato nulla e puoi ripristinarlo quando vuoi.',
    archivedToast: 'Progetto archiviato',
    restoredToast: 'Progetto ripristinato',
